      ...
      <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white flex flex-col items-center justify-center p-10 overflow-hidden relative">
        ...
        >
          ...
          <div className="space-y-8">
            <h1 className="text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-blue-600 leading-tight animate-fade-in">
          ...
          <motion.div 
            ...
            transition={{ duration: 1 }}
            className="relative flex justify-center animate-slide-in"
          >
            <img
