  ...
  return (
    <>
      ...
      <motion.section 
        ...
        className="relative text-center mx-auto p-6 sm:p-10 h-screen bg-gray-900 overflow-hidden flex flex-col items-center justify-center"
      >
        {/* Background Effects */}
        <div className="absolute inset-0 pointer-events-none">
          <motion.div 
            ...
            className="absolute w-80 h-80 sm:w-96 sm:h-96 bg-indigo-700 opacity-30 rounded-full blur-3xl top-10 left-10 animate-pulse"
          ></motion.div>
          <motion.div 
            initial={{ scale: 0 }} 
            animate={{ scale: 1 }} 
            transition={{ duration: 1, delay: 0.6 }} 
            className="absolute w-60 h-60 sm:w-72 sm:h-72 bg-purple-600 opacity-20 rounded-full blur-3xl bottom-10 right-10 animate-pulse"
          ></motion.div>
        </div>
        ...
        <motion.h1 
          ...
          className="max-w-[1200px] text-center mx-auto relative text-4xl sm:text-6xl md:text-8xl font-bold text-white mb-6 drop-shadow-lg"
        >
        ...
        <motion.p 
          ...
          animate={{ opacity: 1, y: 0 }} 
          transition={{ duration: 1, delay: 0.6 }} 
          className="relative text-lg sm:text-xl text-gray-400 max-w-3xl mx-auto mb-10 px-4"
        >
